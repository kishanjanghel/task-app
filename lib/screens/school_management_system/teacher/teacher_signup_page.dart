...
class TeacherSingupPage extends StatefulWidget {
  const TeacherSingupPage({super.key});

  @override
  State<TeacherSingupPage> createState() => _TeacherSingupPageState();
}

class _TeacherSingupPageState extends State<TeacherSingupPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'Welcome to School'),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              svgImage(
                  name: "teacher", height: size.height / 3, width: size.width),
              ...
              CustomButton(label: "Teacher's Signup", onPressed: () {}),
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                ...
                child: const Text("Don't have an account? Teacher's Login"),
              ),
            ],
          ),
        ),
